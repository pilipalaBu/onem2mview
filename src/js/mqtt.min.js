  ...
  return function () {
    ...
    1: [function (e, t, r) {
      (function (r, n) {
        (function () {
          'use strict'
          var i = e('events').EventEmitter, o = e('./store'), s = e('mqtt-packet'), a = e('readable-stream').Writable,
            c = e('inherits'), u = e('reinterval'), l = e('./validations'), f = e('xtend'),
            h = e('debug')('mqttjs:client'), p = r ? r.nextTick : function (e) {
              setTimeout(e, 0)
              ...
              clean: !0,
              resubscribe: !0
            }, b = ['ECONNREFUSED', 'EADDRINUSE', 'ECONNRESET', 'ENOTFOUND'], m = {
              0: '',
          ...
          c(v, i), v.prototype._setupStream = function () {
            ...
            function u () {
              ...
              var e = o.shift()
              if (e) {
                h('work :: packet pulled from queue'), t._handlePacket(e, c)
              } else {
            ...
            if (h('_setupStream :: calling method to clear reconnect'), this._clearReconnect(), h('_setupStream :: using streamBuilder provided to client to create stream'), this.stream = this.streamBuilder(this), n.on('packet', function (e) {
              ...
              i = r, h('writable stream :: parsing buffer'), n.parse(e), u()
            ...
            if (5 === r.protocolVersion && r.properties && r.properties.maximumPacketSize && r.properties.maximumPacketSize < e.length) {
              return this.emit('error', new Error('exceeding packets size ' + e.cmd)), this.end({
                reasonCode: 149,
            ...
            var n, i = [], o = t.shift(), s = o.resubscribe, a = t.pop() || w, c = t.pop(), u = this,
              p = this.options.protocolVersion
            if (delete o.resubscribe, 'string' == typeof o && (o = [o]), 'function' != typeof a && (c = a, a = w), null !== (n = l.validateTopics(o))) return d(a, new Error('Invalid topic ' + n)), this
            if (this._checkDisconnecting(a)) return h('subscribe: discconecting true'), this
            var g = { qos: 0 }
            if (5 === p && (g.nl = !1, g.rap = !1, g.rh = 0), c = f(g, c), Array.isArray(o) ? o.forEach(function (e) {
              if (h('subscribe: array topic %s', e), !u._resubscribeTopics.hasOwnProperty(e) || u._resubscribeTopics[e].qos < c.qos || s) {
                var t = {
                  topic: e,
                  qos: c.qos
                }
                5 === p && (t.nl = c.nl, t.rap = c.rap, t.rh = c.rh, t.properties = c.properties), h('subscribe: pushing topic `%s` and qos `%s` to subs list', t.topic, t.qos), i.push(t)
              }
            }) : Object.keys(o).forEach(function (e) {
              if (h('subscribe: object topic %s', e), !u._resubscribeTopics.hasOwnProperty(e) || u._resubscribeTopics[e].qos < o[e].qos || s) {
                var t = {
                  topic: e,
                  qos: o[e].qos
                }
                5 === p && (t.nl = o[e].nl, t.rap = o[e].rap, t.rh = o[e].rh, t.properties = c.properties), h('subscribe: pushing `%s` to subs list', t), i.push(t)
              }
            }), e = {
              cmd: 'subscribe',
              subscriptions: i,
              ...
              if (this.options.resubscribe) {
                ...
                i.forEach(function (e) {
                  if (u.options.reconnectPeriod > 0) {
                    var t = { qos: e.qos }
                    5 === p && (t.nl = e.nl || !1, t.rap = e.rap || !1, t.rh = e.rh || 0, t.properties = e.properties), u._resubscribeTopics[e.topic] = t, b.push(e.topic)
                  }
            ...
            var i = r.shift(), o = r.pop() || w, s = r.pop()
            ...
            var r, n = arguments[2]
            if (t && (h('_cleanUp :: done callback provided for on stream close'), this.stream.on('close', t)), h('_cleanUp :: forced? %s', e), e) {
              0 === this.options.reconnectPeriod && this.options.clean && (r = this.outgoing) && (h('flush: queue exists? %b', !!r), Object.keys(r).forEach(function (e) {
            ...
            h('_checkPing :: checking ping...'), this.pingResp ? (h('_checkPing :: ping response received. Clearing flag and sending `pingreq`'), this.pingResp = !1, this._sendPacket({ cmd: 'pingreq' })) : (h('_checkPing :: calling _cleanUp with force true'), this._cleanUp(!0))
            ...
            var r = e.topic.toString(), n = e.payload, i = e.qos, o = e.messageId, s = this, a = this.options,
    ...
    5: [function (e, t, r) {
      (function (r, n) {
        (function () {
          ...
          function f (e) {
            let t = e
            return e.hostname || (t.hostname = 'localhost'), e.port || ('wss' === e.protocol ? t.port = 443 : t.port = 80), e.path || (t.path = '/'), e.wsOptions || (t.wsOptions = {}), u || 'wss' !== e.protocol || c.forEach(function (r) {
          ...
          t.exports = u ? function (e, t) {
            ...
            }(t).browserBufferSize || 524288, c = t.browserBufferTimeout || 1e3, u = !t.objectMode
            let h = function (e, t) {
              const r = 'MQIsdp' === t.protocolId && 3 === t.protocolVersion ? 'mqttv3.1' : 'mqtt'
              let n = l(t, e), i = new WebSocket(n, [r])
              return i.binaryType = 'arraybuffer', i
            }(e, t), p = function (e, t, r) {
              let n = new a({ objectModeMode: e.objectMode })
              return n._write = t, n._flush = r, n
            }(t, function e (t, r, o) {
              h.bufferedAmount > i && setTimeout(e, c, t, r, o), u && 'string' == typeof t && (t = n.from(t, 'utf8'))
              try {
                h.send(t)
              } catch (e) {
                return o(e)
            ...
            }(0, n, r), a = i.createWebSocketStream(s, r.wsOptions)
    ...
    11: [function (e, t, r) {
      ...
      o._init = function (e) {
        ...
        const o = !!e, s = this._offset(r), a = i - r
        let c = a, u = o && t || 0, l = s[1]
        ...
        if (c <= this._bufs[s[0]].length - l) return o ? this._bufs[s[0]].copy(e, t, l, l + c) : this._bufs[s[0]].slice(l, l + c)
        o || (e = n.allocUnsafe(a))
        for (let t = s[0]; t < this._bufs.length; t++) {
          const r = this._bufs[t].length - l
          if (!(c > r)) {
            this._bufs[t].copy(e, u, l, l + c), u += r
            break
          }
          this._bufs[t].copy(e, u, l), u += r, c -= r, l && (l = 0)
        }
        ...
        const r = this._offset(e), n = this._offset(t), i = this._bufs.slice(r[0], n[0] + 1)
      ...
      (function (t) {
        (function () {
          ...
          function a (e, t, r) {
            if ('string' == typeof e) {
              return function (e, t) {
                ...
                var r = 0 | h(e, t), n = o(r), i = n.write(e, t)
                i !== r && (n = n.slice(0, i))
                return n
              }(e, t)
            }
          ...
          function P (e, t, r, i, o) {
            return t = +t, r >>>= 0, o || x(e, 0, r, 4), n.write(e, t, r, i, 23, 4), r + 4
          }

          function M (e, t, r, i, o) {
            return t = +t, r >>>= 0, o || x(e, 0, r, 8), n.write(e, t, r, i, 52, 8), r + 8
          }
          ...
          s.prototype.slice = function (e, t) {
            ...
            if (t >>>= 0, r = void 0 === r ? this.length : r >>> 0, e || (e = 0), 'number' == typeof e) {
              ...
              var a = s.isBuffer(e) ? e : s.from(e, n), c = a.length
    ...
    17: [function (e, t, r) {
      (function (r, n) {
        (function () {
          var i = e('readable-stream'), o = e('end-of-stream'), s = e('inherits'), a = e('stream-shift'),
            c = n.from && n.from !== Uint8Array.from ? n.from([0]) : new n([0]), u = function (e, t) {
      ...
      (function (r) {
        (function () {
          var n = e('once'), i = function () {
            ...
            t || (t = {}), s = n(s || i)
            var a = e._writableState, c = e._readableState, u = t.readable || !1 !== t.readable && e.readable,
              l = t.writable || !1 !== t.writable && e.writable, f = !1, h = function () {
                e.writable || p()
              }, p = function () {
                l = !1, u || s.call(e)
              }, d = function () {
        ...
        switch (n = arguments.length) {
          ...
          case 4:
            !function (e, t, r, n, i, o) {
              if (t) e.call(r, n, i, o) else for (var s = e.length, a = b(e, s), c = 0; c < s; ++c) a[c].call(r, n, i, o)
    ...
    20: [function (e, t, r) {
      r.read = function (e, t, r, n, i) {
        var o, s, a = 8 * i - n - 1, c = (1 << a) - 1, u = c >> 1, l = -7, f = r ? i - 1 : 0, h = r ? -1 : 1,
          p = e[t + f]
        ...
        var s, a, c, u = 8 * o - i - 1, l = (1 << u) - 1, f = l >> 1,
    ...
    25: [function (e, t, r) {
      (function (e) {
        (function () {
          const r = 65536, n = {}, i = e.isBuffer(e.from([1, 2]).subarray(0, 1))
    ...
    27: [function (e, t, r) {
      ...
      class c extends i {
        ...
        _parseConnect () {
          let e, t, r, n
          a('_parseConnect')
          const i = {}, o = this.packet, c = this._parseString()
          ...
          if (o.protocolId = c, this._pos >= this._list.length) return this._emitError(new Error('Packet too short'))
        ...
        _parseSubscribe () {
          ...
          if (e.subscriptions = [], this._parseMessageId()) {
            ...
            for (; this._pos < e.length;) {
              ...
              n = (r = this._parseByte()) & s.SUBSCRIBE_OPTIONS_QOS_MASK, c = 0 != (r >> s.SUBSCRIBE_OPTIONS_NL_SHIFT & s.SUBSCRIBE_OPTIONS_NL_MASK), o = 0 != (r >> s.SUBSCRIBE_OPTIONS_RAP_SHIFT & s.SUBSCRIBE_OPTIONS_RAP_MASK), i = r >> s.SUBSCRIBE_OPTIONS_RH_SHIFT & s.SUBSCRIBE_OPTIONS_RH_MASK, u = {
                topic: t,
                qos: n
              }, 5 === this.settings.protocolVersion ? (u.nl = c, u.rap = o, u.rh = i) : this.settings.bridgeMode && (u.rh = 0, u.rap = !0, u.nl = !0), a('_parseSubscribe: push subscription `%s` to subscription', u), e.subscriptions.push(u)
            }
          }
        }
        ...
        _parseString (e) {
          const t = this._parseNum(), r = t + this._pos
        ...
        _parseVarByteNum (e) {
          ...
          for (; r < 4 && c + r < this._list.length;) {
            if (i += n * ((t = this._list.readUInt8(c + r++)) & s.VARBYTEINT_MASK), n *= 128, 0 == (t & s.VARBYTEINT_FIN_MASK)) {
              o = !0
              break
            }
            if (this._list.length <= r) break
          }
          return !o && 4 === r && this._list.length >= r && this._emitError(new Error('Invalid variable byte integer')), c && (this._pos += r), a('_parseVarByteNum: result: %o', o = !!o && (e ? {
            bytes: r,
            value: i
          } : i)), o
        }
        ...
        _parseProperties () {
          a('_parseProperties')
          const e = this._parseVarByteNum(), t = this._pos + e, r = {}
          for (; this._pos < t;) {
            ...
            if ('userProperties' !== t) {
              r[t] ? Array.isArray(r[t]) ? r[t].push(this._parseByType(s.propertiesTypes[t])) : (r[t] = [r[t]], r[t].push(this._parseByType(s.propertiesTypes[t]))) : r[t] = this._parseByType(s.propertiesTypes[t])
            } else {
    ...
    28: [function (e, t, r) {
      (function (r) {
        (function () {
          const n = e('./constants'), i = r.allocUnsafe(0), o = r.from([0]), s = e('./numbers'),
            a = e('process-nextick-args').nextTick, c = e('debug')('mqtt-packet:writeToStream'), u = s.cache,
            l = s.generateNumber, f = s.generateCache, h = s.genBufVariableByteInt, p = s.generate4ByteBuffer
          let d = S, g = !0

          function b (e, t, s) {
            switch (c('generate called'), t.cork && (t.cork(), a(m, t)), g && (g = !1, f()), c('generate: packet.cmd: %s', e.cmd), e.cmd) {
              case'connect':
                return function (e, t, i) {
                  const o = e || {}, s = o.protocolId || 'MQTT'
                  let a = o.protocolVersion || 4
                  const c = o.will
                  let u = o.clean
                  const l = o.keepalive || 0, f = o.clientId || '', h = o.username, p = o.password, g = o.properties
                  void 0 === u && (u = !0)
                  let b = 0
                  ...
                  if (c) {
                    ...
                    if (b += r.byteLength(c.topic) + 2, b += 2, c.payload) {
                  ...
                  t.write(n.CONNECT_HEADER), _(t, b), k(t, s), o.bridgeMode && (a += 128)
                  t.write(131 === a ? n.VERSION131 : 132 === a ? n.VERSION132 : 4 === a ? n.VERSION4 : 5 === a ? n.VERSION5 : n.VERSION3)
                  let S = 0
                  S |= null != h ? n.USERNAME_MASK : 0, S |= null != p ? n.PASSWORD_MASK : 0, S |= c && c.retain ? n.WILL_RETAIN_MASK : 0, S |= c && c.qos ? c.qos << n.WILL_QOS_SHIFT : 0, S |= c ? n.WILL_FLAG_MASK : 0, S |= u ? n.CLEAN_SESSION_MASK : 0, t.write(r.from([S])), d(t, l), 5 === a && m.write()
                  k(t, f), c && (5 === a && y.write(), w(t, c.topic), k(t, c.payload))
                  null != h && k(t, h)
                  null != p && k(t, p)
                  return !0
                }(e, t)
              case'connack':
                return function (e, t, i) {
                  const s = i ? i.protocolVersion : 4, a = e || {}, c = 5 === s ? a.reasonCode : a.returnCode,
                    u = a.properties
                  let l = 2
                  ...
                  t.write(n.CONNACK_HEADER), _(t, l), t.write(a.sessionPresent ? n.SESSIONPRESENT_HEADER : o), t.write(r.from([c])), null != f && f.write()
                  return !0
                }(e, t, s)
              case'publish':
                return function (e, t, o) {
                  c('publish: packet: %o', e)
                  const s = o ? o.protocolVersion : 4, a = e || {}, u = a.qos || 0, l = a.retain ? n.RETAIN_MASK : 0,
                    f = a.topic, h = a.payload || i, p = a.messageId, g = a.properties
                  let b = 0
                  if ('string' == typeof f) {
                    b += r.byteLength(f) + 2
                  } else {
                  ...
                  t.write(n.PUBLISH_HEADER[u][a.dup ? 1 : 0][l ? 1 : 0]), _(t, b), d(t, R(f)), t.write(f), u > 0 && d(t, p)
                  null != m && m.write()
                  return c('publish: payload: %o', h), t.write(h)
                }(e, t, s)
              case'puback':
              case'pubrec':
              case'pubrel':
              case'pubcomp':
                return function (e, t, i) {
                  const o = i ? i.protocolVersion : 4, s = e || {}, a = s.cmd || 'puback', c = s.messageId,
                    u = s.dup && 'pubrel' === a ? n.DUP_MASK : 0
                  let l = 0
                  const f = s.reasonCode, h = s.properties
                  let p = 5 === o ? 3 : 2
                  'pubrel' === a && (l = 1)
                  ...
                  t.write(n.ACKS[a][l][u][0]), _(t, p), d(t, c), 5 === o && t.write(r.from([f]))
                  null !== g && g.write()
                  return !0
                }(e, t, s)
              case'subscribe':
                return function (e, t, i) {
                  c('subscribe: packet: ')
                  const o = i ? i.protocolVersion : 4, s = e || {}, a = s.dup ? n.DUP_MASK : 0, u = s.messageId,
                    l = s.subscriptions, f = s.properties
                  let h = 0
                  ...
                  c('subscribe: writing to stream: %o', n.SUBSCRIBE_HEADER), t.write(n.SUBSCRIBE_HEADER[1][a ? 1 : 0][0]), _(t, h), d(t, u), null !== p && p.write()
                  let g = !0
                  for (const e of l) {
                    const i = e.topic, s = e.qos, a = +e.nl, c = +e.rap, u = e.rh
                    let l
                    w(t, i), l = n.SUBSCRIBE_OPTIONS_QOS[s], 5 === o && (l |= a ? n.SUBSCRIBE_OPTIONS_NL : 0, l |= c ? n.SUBSCRIBE_OPTIONS_RAP : 0, l |= u ? n.SUBSCRIBE_OPTIONS_RH[u] : 0), g = t.write(r.from([l]))
                  }
                  return g
                }(e, t, s)
              case'suback':
                return function (e, t, i) {
                  const o = i ? i.protocolVersion : 4, s = e || {}, a = s.messageId, c = s.granted, u = s.properties
                  let l = 0
              ...
              case'unsubscribe':
                return function (e, t, i) {
                  const o = i ? i.protocolVersion : 4, s = e || {}, a = s.messageId, c = s.dup ? n.DUP_MASK : 0,
                    u = s.unsubscriptions, l = s.properties
                  let f = 0
                  if ('number' != typeof a) return t.emit('error', new Error('Invalid messageId')), !1
                  f += 2
                  ...
                  t.write(n.UNSUBSCRIBE_HEADER[1][c ? 1 : 0][0]), _(t, f), d(t, a), null !== h && h.write()
                  let p = !0
              ...
              case'unsuback':
                return function (e, t, i) {
                  const o = i ? i.protocolVersion : 4, s = e || {}, a = s.messageId, c = s.dup ? n.DUP_MASK : 0,
                    u = s.granted, l = s.properties, f = s.cmd
                  let h = 2
                  if ('number' != typeof a) return t.emit('error', new Error('Invalid messageId')), !1
                  if (5 === o) {
                  ...
                  t.write(n.ACKS[f][0][c][0]), _(t, h), d(t, a), null !== p && p.write()
              ...
              case'disconnect':
                return function (e, t, i) {
                  const o = i ? i.protocolVersion : 4, s = e || {}, a = s.reasonCode, c = s.properties
                  let u = 5 === o ? 1 : 0, l = null
                  if (5 === o) {
                    if (!(l = C(t, c, i, u))) return !1
                    u += l.length
                  }
                  t.write(r.from([n.codes.disconnect << 4])), _(t, u), 5 === o && t.write(r.from([a]))
                  null !== l && l.write()
                  return !0
                }(e, t, s)
              case'auth':
                return function (e, t, i) {
                  ...
                  const l = C(t, c, i, u)
                  if (!l) return !1
                  u += l.length, t.write(r.from([n.codes.auth << 4])), _(t, u), t.write(r.from([a])), null !== l && l.write()
                  return !0
                }(e, t, s)
              default:
          ...
          Object.defineProperty(b, 'cacheNumbers', {
            get: () => d === S,
            set (e) {
              e ? (u && 0 !== Object.keys(u).length || (g = !0), d = S) : (g = !1, d = E)
            }
          })
          const y = {}
          ...
          function _ (e, t) {
            ...
            let r = y[t]
            return r || (r = h(t), t < 16384 && (y[t] = r)), c('writeVarByteInt: writing to stream: %o', r), e.write(r)
          }

          function w (e, t) {
            const n = r.byteLength(t)
            return d(e, n), c('writeString: %s', t), e.write(t, 'utf8')
          }
          ...
          function A (e, t, r) {
            ...
            for (const r in t) {
              if (Object.prototype.hasOwnProperty.call(t, r) && null !== t[r]) {
                const n = t[r]
                if (Array.isArray(n)) for (let t = 0; t < n.length; t++) T(e, r, n[t]) else T(e, r, n)
              }
            }
          }
    ...
    33: [function (e, t, r) {
      (function (e) {
        (function () {
          !function (n) {
            var i = 'object' == typeof r && r && !r.nodeType && r, o = 'object' == typeof t && t && !t.nodeType && t,
              s = 'object' == typeof e && e
            s.global !== s && s.window !== s && s.self !== s || (n = s)
            var a, c, u = 2147483647, l = 36, f = 1, h = 26, p = 38, d = 700, g = 72, b = 128, m = '-', y = /^xn--/,
              _ = /[^\x20-\x7E]/, w = /[\x2E\u3002\uFF0E\uFF61]/g, v = {
            ...
            function x (e, t, r) {
              var n = 0
              for (e = r ? E(e / d) : e >> 1, e += E(e / t); e > S * h >> 1; n += l) e = E(e / S)
              return E(n + (S + 1) * e / (e + p))
            }

            function P (e) {
              var t, r, n, i, o, s, a, c, p, d, y, _ = [], w = e.length, v = 0, S = b, k = g
              for ((r = e.lastIndexOf(m)) < 0 && (r = 0), n = 0; n < r; ++n) e.charCodeAt(n) >= 128 && I('not-basic'), _.push(e.charCodeAt(n))
              for (i = r > 0 ? r + 1 : 0; i < w;) {
                for (o = v, s = 1, a = l; i >= w && I("invalid-input"), ((c = (y = e.charCodeAt(i++)) - 48 < 10 ? y - 22 : y - 65 < 26 ? y - 65 : y - 97 < 26 ? y - 97 : l) >= l || c > E((u - v) / s)) && I("overflow"), v += c * s, !(c < (p = a <= k ? f : a >= k + h ? h : a - k)); a += l) s > E(u / (d = l - p)) && I('overflow'), s *= d
                k = x(v - o, t = _.length + 1, 0 == o), E(v / t) > u - S && I('overflow'), S += E(v / t), v %= t, _.splice(v++, 0, S)
              }
              return R(_)
            }
            ...
            function M (e) {
              ...
              for (_ = (e = A(e)).length, t = b, r = 0, o = g, s = 0; s < _; ++s) (y = e[s]) < 128 && C.push(k(y))
              for (n = i = C.length, i && C.push(m); n < _;) {
                for (a = u, s = 0; s < _; ++s) (y = e[s]) >= t && y < a && (a = y)
                for (a - t > E((u - r) / (w = n + 1)) && I('overflow'), r += (a - t) * w, t = a, s = 0; s < _; ++s) {
                  if ((y = e[s]) < t && ++r > u && I('overflow'), y == t) {
                    for (c = r, p = l; !(c < (d = p <= o ? f : p >= o + h ? h : p - o)); p += l) S = c - d, v = l - d, C.push(k(O(d + S % v, 0))), c = E(S / v)
                    C.push(k(O(c, 0))), o = x(r, w, n == i), r = 0, ++n
                  }
                }
                ++r, ++t
              }
            ...
            if (a = {
              ...
              if (t.exports == i) o.exports = a else for (c in a) a.hasOwnProperty(c) && (i[c] = a[c])
            } else {
              n.punycode = a
            }
          }(this)
    ...
    40: [function (e, t, r) {
      (function (r, n) {
        (function () {
          ...
          var f, h, p, d = e('./internal/streams/buffer_list'), g = e('./internal/streams/destroy'),
            b = e('./internal/streams/state').getHighWaterMark, m = e('../errors').codes, y = m.ERR_INVALID_ARG_TYPE,
            _ = m.ERR_STREAM_PUSH_AFTER_EOF, w = m.ERR_METHOD_NOT_IMPLEMENTED, v = m.ERR_STREAM_UNSHIFT_AFTER_END_EVENT
          e('inherits')(I, s)
          ...
          function T (e, t, r, n) {
            t.flowing && 0 === t.length && !t.sync ? (t.awaitDrain = 0, e.emit('data', r)) : (t.length += t.objectMode ? 1 : r.length, n ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && O(e)), P(e, t)
          }
          ...
          function O (e) {
            ...
            u('emitReadable', t.needReadable, t.emittedReadable), t.needReadable = !1, t.emittedReadable || (u('emitReadable', t.flowing), t.emittedReadable = !0, r.nextTick(x, e))
          }
          ...
          I.prototype.read = function (e) {
            ...
            if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && ((0 !== t.highWaterMark ? t.length >= t.highWaterMark : t.length > 0) || t.ended)) return u('read: emitReadable', t.length, t.ended), 0 === t.length && t.ended ? q(this) : O(this), null
            ...
            function h (t) {
              u('ondata')
              var r = e.write(t)
              u('dest.write', r), !1 === r && ((1 === i.pipesCount && i.pipes === e || i.pipesCount > 1 && -1 !== F(i.pipes, e)) && !f && (u('false write response, pause', i.awaitDrain), i.awaitDrain++), n.pause())
            }

            function p (t) {
              u('onerror', t), b(), e.removeListener('error', p), 0 === o(e, 'error') && S(e, t)
            }
            ...
            return 'data' === e ? (i.readableListening = this.listenerCount('readable') > 0, !1 !== i.flowing && this.resume()) : 'readable' === e && (i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0, i.flowing = !1, i.emittedReadable = !1, u('on readable', i.length, i.reading), i.length ? O(this) : i.reading || r.nextTick(B, this))), n
          ...
          }), I._fromList = j, Object.defineProperty(I.prototype, 'readableLength', {
            enumerable: !1,
            get: function () {
    ...
    41: [function (e, t, r) {
      ...
      var n = e('../errors').codes, i = n.ERR_METHOD_NOT_IMPLEMENTED, o = n.ERR_MULTIPLE_CALLBACK,
        s = n.ERR_TRANSFORM_ALREADY_TRANSFORMING, a = n.ERR_TRANSFORM_WITH_LENGTH_0, c = e('./_stream_duplex')
    ...
    42: [function (e, t, r) {
      (function (r, n) {
        (function () {
          ...
          var s = { deprecate: e('util-deprecate') }, a = e('./internal/streams/stream'), c = e('buffer').Buffer,
            u = n.Uint8Array || function () {
            }
          var l, f = e('./internal/streams/destroy'), h = e('./internal/streams/state').getHighWaterMark,
            p = e('../errors').codes, d = p.ERR_INVALID_ARG_TYPE, g = p.ERR_METHOD_NOT_IMPLEMENTED,
            b = p.ERR_MULTIPLE_CALLBACK, m = p.ERR_STREAM_CANNOT_PIPE, y = p.ERR_STREAM_DESTROYED,
            _ = p.ERR_STREAM_NULL_VALUES, w = p.ERR_STREAM_WRITE_AFTER_END, v = p.ERR_UNKNOWN_ENCODING,
            S = f.errorOrDestroy
            ...
            this.decodeStrings = !a, this.defaultEncoding = t.defaultEncoding || 'utf8', this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function (e) {
              !function (e, t) {
                ...
                if (function (e) {
                  ...
                  !function (e, t, n, i, o) {
                    --t.pendingcb, n ? (r.nextTick(o, i), r.nextTick(x, e, t), e._writableState.errorEmitted = !0, S(e, i)) : (o(i), e._writableState.errorEmitted = !0, S(e, i), x(e, t))
                  }(e, n, i, t, o)
                } else {
                  var s = R(n) || e.destroyed
                  s || n.corked || n.bufferProcessing || !n.bufferedRequest || A(e, n), i ? r.nextTick(T, e, n, s, o) : T(e, n, s, o)
                }
              }(n, e)
          ...
          function A (e, t) {
            ...
            if (e._writev && r && r.next) {
              ...
              o.allBuffers = c, C(e, t, !0, t.length, o, '', s.finish), t.pendingcb++, t.lastBufferedRequest = null, s.next ? (t.corkedRequestsFree = s.next, s.next = null) : t.corkedRequestsFree = new i(t), t.bufferedRequestCount = 0
            } else {
              for (; r;) {
                var u = r.chunk, l = r.encoding, f = r.callback
                if (C(e, t, !1, t.objectMode ? 1 : u.length, u, l, f), r = r.next, t.bufferedRequestCount--, t.writing) break
              }
          ...
          function O (e, t) {
            e._final(function (r) {
              t.pendingcb--, r && S(e, r), t.prefinished = !0, e.emit('prefinish'), x(e, t)
            })
          }
          ...
          e('inherits')(I, a), k.prototype.getBuffer = function () {
            ...
            var i, o = this._writableState, s = !1, a = !o.objectMode && (i = e, c.isBuffer(i) || i instanceof u)
            ...
            return 'function' == typeof e ? (n = e, e = null, t = null) : 'function' == typeof t && (n = t, t = null), null !== e && void 0 !== e && this.write(e, t), i.corked && (i.corked = 1, this.uncork()), i.ending || function (e, t, n) {
              t.ending = !0, x(e, t), n && (t.finished ? r.nextTick(n) : e.once('finish', n))
    ...
    43: [function (e, t, r) {
      (function (r) {
        (function () {
          ...
          var o = e('./end-of-stream'), s = Symbol('lastResolve'), a = Symbol('lastReject'), c = Symbol('error'),
            u = Symbol('ended'), l = Symbol('lastPromise'), f = Symbol('handlePromise'), h = Symbol('stream')
          ...
          t.exports = function (e) {
            ...
            return n[l] = null, o(e, function (e) {
              if (e && 'ERR_STREAM_PREMATURE_CLOSE' !== e.code) {
                var t = n[a]
                return null !== t && (n[l] = null, n[s] = null, n[a] = null, t(e)), void (n[c] = e)
              }
              var r = n[s]
              null !== r && (n[l] = null, n[s] = null, n[a] = null, r(p(void 0, !0))), n[u] = !0
    ...
    46: [function (e, t, r) {
      ...
      t.exports = function e (t, r, o) {
        ...
        var s = r.readable || !1 !== r.readable && t.readable, a = r.writable || !1 !== r.writable && t.writable,
          c = function () {
            t.writable || l()
            ...
            var e
            return s && !f ? (t._readableState && t._readableState.ended || (e = new n), o.call(t, e)) : a && !u ? (t._writableState && t._writableState.ended || (e = new n), o.call(t, e)) : void 0
          }, g = function () {
            t.req.on('finish', l)
          }
        return function (e) {
          return e.setHeader && 'function' == typeof e.abort
        }(t) ? (t.on('complete', l), t.on('abort', d), t.req ? g() : t.on('request', g)) : a && !t._writableState && (t.on('end', c), t.on('close', c)), t.on('end', h), t.on('finish', l), !1 !== r.error && t.on('error', p), t.on('close', d), function () {
          t.removeListener('complete', l), t.removeListener('abort', d), t.removeListener('request', g), t.req && t.req.removeListener('finish', l), t.removeListener('end', c), t.removeListener('close', c), t.removeListener('finish', l), t.removeListener('end', h), t.removeListener('error', p), t.removeListener('close', d)
        }
      }
    }, { '../../../errors': 37 }],
    47: [function (e, t, r) {
    ...
    56: [function (e, t, r) {
      ...
      o.prototype.parse = function (e, t, r) {
        ...
        if (!b[v] && (E || v && !m[v])) {
          ...
          if (!R) {
            for (var O = this.hostname.split(/\./), x = (T = 0, O.length); T < x; T++) {
              var P = O[T]
              if (P && !P.match(p)) {
                for (var M = '', L = 0, B = P.length; L < B; L++) P.charCodeAt(L) > 127 ? M += 'x' : M += P[L]
                if (!M.match(p)) {
                  var N = O.slice(0, T), U = O.slice(T + 1), j = P.match(d)
                  j && (N.push(j[1]), U.unshift(j[2])), U.length && (_ = '/' + U.join('.') + _), this.hostname = N.join('.')
                  break
                }
              }
            }
        ...
        if (!g[S]) {
          for (T = 0, x = l.length; T < x; T++) {
            ...
            if (-1 !== _.indexOf(F)) {
              ...
              V === F && (V = escape(F)), _ = _.split(F).join(V)
            }
          }
        }
        var W = _.indexOf('#');
        ...
        var H = _.indexOf('?')
        if (-1 !== H ? (this.search = _.substr(H), this.query = _.substr(H + 1), t && (this.query = y.parse(this.query)), _ = _.slice(0, H)) : t && (this.search = '', this.query = {}), _ && (this.pathname = _), m[S] && this.hostname && !this.pathname && (this.pathname = '/'), this.pathname || this.search) {
          q = this.pathname || ''
          var K = this.search || ''
          this.path = q + K
        }
        ...
        if (e.protocol && e.protocol !== r.protocol) {
          ...
          if (r.search = e.search, r.query = e.query, r.host = e.host || '', r.auth = e.auth, r.hostname = e.hostname || e.host, r.port = e.port, r.pathname || r.search) {
            var g = r.pathname || '', y = r.search || ''
            r.path = g + y
          }
          return r.slashes = r.slashes || e.slashes, r.href = r.format(), r
        }
        var _ = r.pathname && '/' === r.pathname.charAt(0), w = e.host || e.pathname && '/' === e.pathname.charAt(0),
          v = w || _ || r.host && e.pathname, S = v, E = r.pathname && r.pathname.split('/') || [],
          k = (d = e.pathname && e.pathname.split('/') || [], r.protocol && !m[r.protocol])
        if (k && (r.hostname = '', r.port = null, r.host && ('' === E[0] ? E[0] = r.host : E.unshift(r.host)), r.host = '', e.protocol && (e.hostname = null, e.port = null, e.host && ('' === d[0] ? d[0] = e.host : d.unshift(e.host)), e.host = null), v = v && ('' === d[0] || '' === E[0])), w) {
          r.host = e.host || '' === e.host ? e.host : r.host, r.hostname = e.hostname || '' === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, E = d
        } else if (d.length) {
          E || (E = []), E.pop(), E = E.concat(d), r.search = e.search, r.query = e.query
        ...
        for (var I = E.slice(-1)[0], C = (r.host || e.host || E.length > 1) && ('.' === I || '..' === I) || '' === I, T = 0, A = E.length; A >= 0; A--) '.' === (I = E[A]) ? E.splice(A, 1) : '..' === I ? (E.splice(A, 1), T++) : T && (E.splice(A, 1), T--)
        if (!v && !S) for (; T--; T) E.unshift('..')
        !v || '' === E[0] || E[0] && '/' === E[0].charAt(0) || E.unshift(''), C && '/' !== E.join('/').substr(-1) && E.push('')
        var R, O = '' === E[0] || E[0] && '/' === E[0].charAt(0)
        k && (r.hostname = r.host = O ? '' : E.length ? E.shift() : '', (R = !!(r.host && r.host.indexOf('@') > 0) && r.host.split('@')) && (r.auth = R.shift(), r.host = r.hostname = R.shift()))
        return (v = v || r.host && E.length) && !O && E.unshift(''), E.length ? r.pathname = E.join('/') : (r.pathname = null, r.path = null), i.isNull(r.pathname) && i.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r
